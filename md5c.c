...
/* gamex86.dll 0x2001f0f0-0x2001f120 (padded+collision-resolved) */
/* gamei386.so 0x0005890c-0x000589e3 */
void MD5Print (unsigned char digest[16], char *outbuf)
{
    unsigned int    i;

    for (i = 0; i < 16; i++)
        sprintf (outbuf + i*2, "%02x", digest[i]);
}

/* gamex86.dll 0x2001f120-0x2001f170 (shape-matched(ratio=0.86)) */
/* gamei386.so 0x000589e4-0x00058b87 */
