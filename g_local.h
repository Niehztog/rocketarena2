...
// Rocket Arena's own statusbar slots.  These lived in RA2's private q_shared.h,
// which this port drops in favour of the engine's shared.h; RA2 reuses slots 16
// and 17 (baseq2's STAT_CHASE/STAT_SPECTATOR) for its own purposes.
...
// arena.c calls these three; Q2PRO made them static when only p_client.c used them
...
// the grapple in arena.c drives the standard weapon animation loop
...
// the grapple pull in arena.c applies gravity itself
